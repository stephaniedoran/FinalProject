...
class PatientStateMonitor:
    ...
    def update(self, k, next_state):
        ...
        if next_state is P.HealthStats.DEAD_STROKE or next_state is P.HealthStats.DEAD_OTHER:
        ...
        # update stroke count
        if self._currentState == P.HealthStats.TIA or self._currentState == P.HealthStats.MILD_STROKE \
                or self._currentState == P.HealthStats.MODERATE_SEVERE_STROKE:
    ...
    def get_if_alive(self):
        result = True
        if self._currentState == P.HealthStats.DEAD_OTHER or self._currentState == P.HealthStats.DEAD_STROKE:
            result = False
        return result
